...
$mail_intervenant = traiter_variable("mail_intervenant");
$tel_intervenant =traiter_tel("tel_intervenant");
...
$adresse_intervenant= $adresse_intervenant." ".$cp_intervenant.' '.$ville_intervenant;
...
$president = get_parametre("president",date_traitee_to_date_sql($date_rp));
// -----------------
// Load the template
// -----------------

$template = get_doc_type("rp",date_traitee_to_date_sql($date_rp));
...
$output_file_name = $refetude."-RP.docx";
